...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/RootRefresh/TRUNetworking'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'RootRefresh' => 'wangbf@jfinfo.com' }
  s.source           = { :git => 'https://github.com/RootRefresh/TRUNetworking.git', :tag => s.version.to_s }
